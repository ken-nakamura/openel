...
//	HALFLOAT_T posX, posY;
	...
	HalActuatorSetValue(halMotor01,HAL_REQUEST_VELOCITY_CONTROL,posX*100);
	HalActuatorSetValue(halMotor02,HAL_REQUEST_VELOCITY_CONTROL,-posX*100);
}
